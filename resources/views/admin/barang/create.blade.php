        ...
        <form action="{{url('/admin/barang/store')}}" method="POST">
          ...
          <fieldset >
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" id="kurir_id" name="kurir_id" class="form-control" placeholder="input....">
            </div>
          </div>
            <div class="mb-3">
              <label for="disabledTextInput" class="form-label">Berat</label>
              <input type="text" id="berat" name="berat" class="form-control" placeholder="input....">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" id="tarif" name="tarif" class="form-control" placeholder="input....">
            </div>
            </div>
