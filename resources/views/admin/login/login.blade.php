      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
              @if(session('berhasil_registrasi'))
                  <div class="alert alert-success">
                      {{ session('berhasil_registrasi') }}
                  </div>
              @endif

                <h1 class="h4 text-gray-900 mb-4 center" style="text-align:center">Login Here!!!</h1>
                <form action="{{url('/login')}}" method="POST">
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <a class="text-primary fw-bold ms-2" href="{{url('register')}}">Belum Punya Akun? Register Sekarang!</a>
                  </div>
                </form>
              </div>
            </div>
